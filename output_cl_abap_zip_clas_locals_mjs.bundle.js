"use strict";
(self["webpackChunkabap2ui5"] = self["webpackChunkabap2ui5"] || []).push([["output_cl_abap_zip_clas_locals_mjs"],{
...
class lcl_stream {
  ...
  async append_crc(INPUT) {
    ...
    if (abap.compare.eq(abap.builtin.xstrlen({val: lcl_stream.crc32_map}), abap.IntegerFactory.get(0))) {
      ...
      const unique761 = new abap.types.Integer().set(256).get();
      for (let unique762 = 0; unique762 < unique761; unique762++) {
        ...
        const unique763 = abap.IntegerFactory.get(8).get();
    ...
    const unique765 = len.get();
    for (let unique766 = 0; unique766 < unique765; unique766++) {
      abap.builtin.sy.get().index.set(unique766 + 1);
