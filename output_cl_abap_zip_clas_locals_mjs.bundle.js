"use strict";
(self["webpackChunkabap2ui5_web"] = self["webpackChunkabap2ui5_web"] || []).push([["output_cl_abap_zip_clas_locals_mjs"],{
...
class lcl_stream {
  ...
  async append_crc(INPUT) {
    ...
    if (abap.compare.eq(abap.builtin.xstrlen({val: lcl_stream.crc32_map}), abap.IntegerFactory.get(0))) {
      ...
      const unique617 = new abap.types.Integer().set(256).get();
      for (let unique618 = 0; unique618 < unique617; unique618++) {
        abap.builtin.sy.get().index.set(unique618 + 1);
        ...
        const unique619 = abap.IntegerFactory.get(8).get();
        for (let unique620 = 0; unique620 < unique619; unique620++) {
          abap.builtin.sy.get().index.set(unique620 + 1);
    ...
    const unique621 = len.get();
    for (let unique622 = 0; unique622 < unique621; unique622++) {
      abap.builtin.sy.get().index.set(unique622 + 1);
