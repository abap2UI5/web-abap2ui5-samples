"use strict";
(self["webpackChunkabap2ui5"] = self["webpackChunkabap2ui5"] || []).push([["output_z2ui5_cl_ajson_filter_lib_clas_locals_mjs"],{

/***/ "./output/z2ui5_cl_ajson_filter_lib.clas.locals.mjs":
/*!**********************************************************!*\
  !*** ./output/z2ui5_cl_ajson_filter_lib.clas.locals.mjs ***!
  \**********************************************************/
...
/* harmony export */   lcl_and_filter: () => (/* binding */ lcl_and_filter),
/* harmony export */   lcl_empty_filter: () => (/* binding */ lcl_empty_filter),
/* harmony export */   lcl_paths_filter: () => (/* binding */ lcl_paths_filter)
/* harmony export */ });
...
class lcl_empty_filter {
  ...
  static ATTRIBUTES = {"Z2UI5_IF_AJSON_FILTER~VISIT_TYPE": {"type": () => {return new abap.types.Structure({
  "value": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
  "open": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
  "close": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": "X", "is_class": "X"}};
  static METHODS = {};
  constructor() {
...
lcl_empty_filter.z2ui5_if_ajson_filter$visit_type = new abap.types.Structure({
"value": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
"open": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
"close": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"})}, undefined, undefined, {}, {});
...
class lcl_paths_filter {
  ...
  "Z2UI5_IF_AJSON_FILTER~VISIT_TYPE": {"type": () => {return new abap.types.Structure({
  "value": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
  "open": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
  "close": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": "X", "is_class": "X"}};
  ...
  async z2ui5_if_ajson_filter$keep_node(INPUT) {
    ...
    if (abap.compare.eq(this.mv_pattern_search, abap.builtin.abap_true)) {
      ...
      for await (const unique35 of abap.statements.loop(this.mt_skip_paths)) {
        fs_p_.assign(unique35);
  ...
  async constructor_(INPUT) {
    ...
    if (abap.compare.eq(abap.builtin.boolc(abap.compare.initial(iv_skip_paths)), abap.builtin.boolc(abap.compare.initial(it_skip_paths)))) {
      await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(24, 'no filter path specified')});
    }
    for await (const unique36 of abap.statements.loop(it_skip_paths)) {
      lv_s.set(unique36);
    ...
    if (abap.compare.initial(iv_skip_paths) === false) {
      ...
      for await (const unique37 of abap.statements.loop(lt_tab)) {
        fs_s_.assign(unique37);
...
lcl_paths_filter.z2ui5_if_ajson_filter$visit_type = new abap.types.Structure({
"value": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
"open": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
"close": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"})}, undefined, undefined, {}, {});
...
class lcl_and_filter {
  ...
  async z2ui5_if_ajson_filter$keep_node(INPUT) {
    ...
    rv_keep.set(abap.builtin.abap_true);
    for await (const unique38 of abap.statements.loop(this.mt_filters)) {
      li_filter.set(unique38);
  ...
  async constructor_(INPUT) {
    ...
    let li_filter = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_AJSON_FILTER", RTTIName: "\\INTERFACE=Z2UI5_IF_AJSON_FILTER"});
    for await (const unique39 of abap.statements.loop(it_filters,{where: async (I) => {return abap.compare.initial(I.table_line) === false;}})) {
      li_filter.set(unique39);
...
lcl_and_filter.z2ui5_if_ajson_filter$visit_type = new abap.types.Structure({
"value": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
"open": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"}),
"close": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_FILTER=>TY_VISIT_TYPE"})}, undefined, undefined, {}, {});
...
//# sourceMappingURL=output_z2ui5_cl_ajson_filter_lib_clas_locals_mjs.bundle.js.map