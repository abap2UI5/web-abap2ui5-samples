...
/* harmony export */ });
const {z2ui5_cl_util_abap} = await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./z2ui5_cl_util_abap.clas.mjs */ "./output/z2ui5_cl_util_abap.clas.mjs"));
...
class lcl_msp_mapper {
  ...
  static async msg_get(INPUT) {
    ...
    let unique66 = lv_kind;
    if (abap.compare.eq(unique66, abap.Classes['CL_ABAP_DATADESCR'].typekind_table)) {
      abap.statements.assign({target: fs_tab_, source: val});
      for await (const unique67 of abap.statements.loop(fs_tab_)) {
        fs_row_.assign(unique67);
        lt_tab.set((await this.msg_get({val: fs_row_})));
        abap.statements.insertInternal({lines: true, data: lt_tab, table: result});
      }
    } else if (abap.compare.eq(unique66, abap.Classes['CL_ABAP_DATADESCR'].typekind_struct1) || abap.compare.eq(unique66, abap.Classes['CL_ABAP_DATADESCR'].typekind_struct2)) {
      ...
      for await (const unique68 of abap.statements.loop(lt_attri)) {
        ls_attri.assign(unique68);
      ...
      } else if (abap.compare.eq(unique66, abap.Classes['CL_ABAP_DATADESCR'].typekind_oref)) {
        try {
          ...
          for await (const unique70 of abap.statements.loop(lt_attri_o,{where: async (I) => {return abap.compare.eq(I.visibility, new abap.types.Character(1).set('U'));},topEquals: {"visibility": new abap.types.Character(1).set('U')}})) {
            ls_attri_o.assign(unique70);
                ...
                if ((abap.Classes['CX_ROOT'] && e instanceof abap.Classes['CX_ROOT'])) {
                  try {
                    ...
                    if ((abap.Classes['CX_ROOT'] && e instanceof abap.Classes['CX_ROOT'])) {
                      lx2.set(e);
                      lt_attri_o.set((await abap.Classes['Z2UI5_CL_UTIL'].rtti_get_t_attri_by_oref({val: val})));
                      for await (const unique69 of abap.statements.loop(lt_attri_o,{where: async (I) => {return abap.compare.eq(I.visibility, new abap.types.Character(1).set('U'));},topEquals: {"visibility": new abap.types.Character(1).set('U')}})) {
                        ls_attri_o.assign(unique69);
        ...
        static async msg_map(INPUT) {
          ...
          result.set(is_msg);
          let unique71 = name;
          if (abap.compare.eq(unique71, new abap.types.Character(2).set('ID')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGID'))) {
            result.get().id.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(2).set('NO')) || abap.compare.eq(unique71, new abap.types.Character(6).set('NUMBER')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGNO'))) {
            result.get().no.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(7).set('MESSAGE')) || abap.compare.eq(unique71, new abap.types.Character(4).set('TEXT'))) {
            result.get().text.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(4).set('TYPE')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGTY'))) {
            result.get().type.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(10).set('MESSAGE_V1')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGV1')) || abap.compare.eq(unique71, new abap.types.Character(2).set('V1'))) {
            result.get().v1.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(10).set('MESSAGE_V2')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGV2')) || abap.compare.eq(unique71, new abap.types.Character(2).set('V2'))) {
            result.get().v2.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(10).set('MESSAGE_V3')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGV3')) || abap.compare.eq(unique71, new abap.types.Character(2).set('V3'))) {
            result.get().v3.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(10).set('MESSAGE_V4')) || abap.compare.eq(unique71, new abap.types.Character(5).set('MSGV4')) || abap.compare.eq(unique71, new abap.types.Character(2).set('V4'))) {
            result.get().v4.set(val);
          } else if (abap.compare.eq(unique71, new abap.types.Character(9).set('TIME_STMP'))) {
