"use strict";
(self["webpackChunkabap2ui5"] = self["webpackChunkabap2ui5"] || []).push([["output_z2ui5_cl_ajson_mapping_clas_locals_mjs"],{

/***/ "./output/z2ui5_cl_ajson_mapping.clas.locals.mjs":
/*!*******************************************************!*\
  !*** ./output/z2ui5_cl_ajson_mapping.clas.locals.mjs ***!
  \*******************************************************/
...
/* harmony export */   lcl_compound_mapper: () => (/* binding */ lcl_compound_mapper),
/* harmony export */   lcl_mapping_camel: () => (/* binding */ lcl_mapping_camel),
/* harmony export */   lcl_mapping_fields: () => (/* binding */ lcl_mapping_fields),
/* harmony export */   lcl_mapping_to_lower: () => (/* binding */ lcl_mapping_to_lower),
/* harmony export */   lcl_mapping_to_upper: () => (/* binding */ lcl_mapping_to_upper),
/* harmony export */   lcl_rename: () => (/* binding */ lcl_rename),
/* harmony export */   lcl_to_camel: () => (/* binding */ lcl_to_camel),
/* harmony export */   lcl_to_snake: () => (/* binding */ lcl_to_snake)
/* harmony export */ });
...
class lcl_mapping_fields {
  ...
  static ATTRIBUTES = {"MT_MAPPING_FIELDS": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "abap": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-ABAP"}),
  "json": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-JSON"})}, "z2ui5_if_ajson_mapping=>ty_mapping_field", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[{"name":"abap","type":"SORTED","isUnique":true,"keyFields":["ABAP"]},{"name":"json","type":"SORTED","isUnique":true,"keyFields":["JSON"]}]}, "z2ui5_if_ajson_mapping=>ty_mapping_fields");}, "visibility": "I", "is_constant": " ", "is_class": " "}};
  static METHODS = {"CONSTRUCTOR": {"visibility": "U", "parameters": {"IT_MAPPING_FIELDS": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "abap": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-ABAP"}),
  ...
  constructor() {
    ...
    this.mt_mapping_fields = abap.types.TableFactory.construct(new abap.types.Structure({
    "abap": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-ABAP"}),
    "json": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-JSON"})}, "z2ui5_if_ajson_mapping=>ty_mapping_field", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[{"name":"abap","type":"SORTED","isUnique":true,"keyFields":["ABAP"]},{"name":"json","type":"SORTED","isUnique":true,"keyFields":["JSON"]}]}, "z2ui5_if_ajson_mapping=>ty_mapping_fields");
  }
  async constructor_(INPUT) {
    let it_mapping_fields = abap.types.TableFactory.construct(new abap.types.Structure({
    "abap": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-ABAP"}),
    "json": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-JSON"})}, "z2ui5_if_ajson_mapping=>ty_mapping_field", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[{"name":"abap","type":"SORTED","isUnique":true,"keyFields":["ABAP"]},{"name":"json","type":"SORTED","isUnique":true,"keyFields":["JSON"]}]}, "z2ui5_if_ajson_mapping=>ty_mapping_fields");
    if (INPUT && INPUT.it_mapping_fields) {it_mapping_fields.set(INPUT.it_mapping_fields);}
    let ls_mapping_field = new abap.types.Structure({
    "abap": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-ABAP"}),
    "json": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_MAPPING_FIELD-JSON"})}, "z2ui5_if_ajson_mapping=>ty_mapping_field", undefined, {}, {});
    for await (const unique40 of abap.statements.loop(it_mapping_fields)) {
      ls_mapping_field.set(unique40);
...
class lcl_rename {
  ...
  static IMPLEMENTED_INTERFACES = ["Z2UI5_IF_AJSON_MAPPING","IF_SERIALIZABLE_OBJECT"];
  static ATTRIBUTES = {"MT_RENAME_MAP": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "from": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-FROM"}),
  "to": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-TO"})}, "z2ui5_if_ajson_mapping=>ty_rename", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[{"name":"by_name","type":"SORTED","isUnique":true,"keyFields":["FROM"]}]}, "z2ui5_if_ajson_mapping=>tty_rename_map");}, "visibility": "I", "is_constant": " ", "is_class": " "},
  "MV_RENAME_BY": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "visibility": "I", "is_constant": " ", "is_class": " "}};
  static METHODS = {"CONSTRUCTOR": {"visibility": "U", "parameters": {"IT_RENAME_MAP": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "from": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-FROM"}),
  ...
  constructor() {
    ...
    this.mt_rename_map = abap.types.TableFactory.construct(new abap.types.Structure({
    "from": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-FROM"}),
    "to": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-TO"})}, "z2ui5_if_ajson_mapping=>ty_rename", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[{"name":"by_name","type":"SORTED","isUnique":true,"keyFields":["FROM"]}]}, "z2ui5_if_ajson_mapping=>tty_rename_map");
  ...
  async constructor_(INPUT) {
    ...
    if (it_rename_map === undefined) { it_rename_map = abap.types.TableFactory.construct(new abap.types.Structure({
    "from": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-FROM"}),
  ...
  async z2ui5_if_ajson_mapping$rename_node(INPUT) {
    ...
    let fs_r_ = new abap.types.FieldSymbol(new abap.types.Structure({
    "from": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-FROM"}),
    "to": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_MAPPING=>TY_RENAME-TO"})}, "z2ui5_if_ajson_mapping=>ty_rename", undefined, {}, {}));
    let unique41 = this.mv_rename_by;
    if (abap.compare.eq(unique41, abap.Classes['Z2UI5_CL_AJSON_MAPPING'].rename_by.get().attr_name)) {
    ...
    } else if (abap.compare.eq(unique41, abap.Classes['Z2UI5_CL_AJSON_MAPPING'].rename_by.get().full_path)) {
      ...
      lv_pair_found.set(abap.builtin.boolc(abap.compare.eq(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))));
    } else if (abap.compare.eq(unique41, abap.Classes['Z2UI5_CL_AJSON_MAPPING'].rename_by.get().pattern)) {
      lv_full_path.set(abap.operators.concat(is_node.get().path,cv_name));
      for await (const unique42 of abap.statements.loop(this.mt_rename_map)) {
        fs_r_.assign(unique42);
...
class lcl_compound_mapper {
  ...
  async z2ui5_if_ajson_mapping$rename_node(INPUT) {
    ...
    ls_node.set(is_node);
    for await (const unique44 of abap.statements.loop(this.mt_queue)) {
      li_mapper.set(unique44);
...
class lcl_to_camel {
  ...
  async z2ui5_if_ajson_mapping$rename_node(INPUT) {
    ...
    await abap.statements.deleteInternal(lt_tokens,{where: async (I) => {return abap.compare.initial(I.table_line);}});
    for await (const unique45 of abap.statements.loop(lt_tokens,{from: lv_from})) {
      fs_token_.assign(unique45);
...
//# sourceMappingURL=output_z2ui5_cl_ajson_mapping_clas_locals_mjs.bundle.js.map