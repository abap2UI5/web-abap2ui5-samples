"use strict";
(self["webpackChunkabap2ui5"] = self["webpackChunkabap2ui5"] || []).push([["output_z2ui5_cl_ajson_clas_locals_mjs"],{

/***/ "./output/z2ui5_cl_ajson.clas.locals.mjs":
/*!***********************************************!*\
  !*** ./output/z2ui5_cl_ajson.clas.locals.mjs ***!
  \***********************************************/
...
/* harmony export */   lcl_abap_to_json: () => (/* binding */ lcl_abap_to_json),
/* harmony export */   lcl_filter_runner: () => (/* binding */ lcl_filter_runner),
/* harmony export */   lcl_json_parser: () => (/* binding */ lcl_json_parser),
/* harmony export */   lcl_json_serializer: () => (/* binding */ lcl_json_serializer),
/* harmony export */   lcl_json_to_abap: () => (/* binding */ lcl_json_to_abap),
/* harmony export */   lcl_mapper_runner: () => (/* binding */ lcl_mapper_runner),
/* harmony export */   lcl_mutator_queue: () => (/* binding */ lcl_mutator_queue),
/* harmony export */   lcl_utils: () => (/* binding */ lcl_utils),
/* harmony export */   lif_kind: () => (/* binding */ lif_kind),
/* harmony export */   lif_mutator_runner: () => (/* binding */ lif_mutator_runner)
/* harmony export */ });
...
class lif_kind {
  ...
  "NUMERIC": {"type": () => {return new abap.types.Structure({
  "int1": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "int2": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "int4": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "int8": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "float": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "packed": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "decfloat16": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "decfloat34": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": "X", "is_class": "X"},
  "TEXTS": {"type": () => {return new abap.types.Structure({
  "char": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "numc": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "string": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": "X", "is_class": "X"},
  "BINARY": {"type": () => {return new abap.types.Structure({
  "hex": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "xstring": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": "X", "is_class": "X"},
  "DEEP_TARGETS": {"type": () => {return new abap.types.Structure({
  "table": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "struct_flat": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "struct_deep": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "data_ref": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "object_ref": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});}, "visibility": "U", "is_constant": "X", "is_class": "X"}};
  static METHODS = {};
}
...
lif_kind.lif_kind$numeric = new abap.types.Structure({
"int1": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"int2": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"int4": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"int8": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
...
"packed": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"decfloat16": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"decfloat34": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});
...
lif_kind.lif_kind$texts = new abap.types.Structure({
"char": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"numc": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"string": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});
lif_kind.lif_kind$texts.get().char.set('C');
lif_kind.lif_kind$texts.get().numc.set('N');
lif_kind.lif_kind$texts.get().string.set('g');
lif_kind.lif_kind$binary = new abap.types.Structure({
"hex": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"xstring": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});
lif_kind.lif_kind$binary.get().hex.set('X');
lif_kind.lif_kind$binary.get().xstring.set('y');
lif_kind.lif_kind$deep_targets = new abap.types.Structure({
"table": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"struct_flat": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"struct_deep": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"data_ref": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
"object_ref": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"})}, undefined, undefined, {}, {});
...
class lcl_utils {
  ...
  "SPLIT_PATH": {"visibility": "U", "parameters": {"RV_PATH_NAME": {"type": () => {return new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_PATH": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}}},
  ...
  "XSTRING_TO_STRING_UTF8": {"visibility": "U", "parameters": {"RV_STR": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "IV_XSTR": {"type": () => {return new abap.types.XString({qualifiedName: "XSTRING"});}, "is_optional": " "}}},
  "ANY_TO_XSTRING": {"visibility": "U", "parameters": {"RV_XSTR": {"type": () => {return new abap.types.XString({qualifiedName: "XSTRING"});}, "is_optional": " "}, "IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}}},
  "ANY_TO_STRING": {"visibility": "U", "parameters": {"RV_STR": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}}}};
  constructor() {
  ...
  static async string_to_xstring_utf8(INPUT) {
    ...
    lv_out_ce.set(abap.CharacterFactory.get(19, 'CL_ABAP_CONV_OUT_CE'));
    try {
      ...
      rv_xstr.set(await abap.dynamicCallLookup(lo_conv.get(), "if_abap_conv_out$convert")({source: iv_str}));
    } catch (e) {
      if ((abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'] && e instanceof abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'])) {
        ...
        lo_conv.set(await abap.Classes[lv_out_ce.get().trimEnd()].create({encoding: abap.CharacterFactory.get(5, 'UTF-8')}));
        await abap.dynamicCallLookup(lo_conv.get(), "convert")({data: iv_str,buffer: rv_xstr});
      } else {
        throw e;
      }
    }
  ...
  async xstring_to_string_utf8(INPUT) {
    return lcl_utils.xstring_to_string_utf8(INPUT);
  }
  static async xstring_to_string_utf8(INPUT) {
    ...
    let lo_conv = new abap.types.ABAPObject({qualifiedName: undefined, RTTIName: undefined});
    let lv_in_ce = new abap.types.String({qualifiedName: "STRING"});
    lv_in_ce.set(abap.CharacterFactory.get(18, 'CL_ABAP_CONV_IN_CE'));
    try {
      if (abap.Classes['CL_ABAP_CONV_CODEPAGE'.trimEnd()] === undefined) { if (abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'.trimEnd()] === undefined) { throw "CX_SY_DYN_CALL_ILLEGAL_CLASS not found"; } else {throw new abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'.trimEnd()](); } }
      ...
      lo_conv.set(await abap.Classes['CL_ABAP_CONV_CODEPAGE'.trimEnd()].create_in());
      rv_str.set(await abap.dynamicCallLookup(lo_conv.get(), "if_abap_conv_in$convert")({source: iv_xstr}));
    } catch (e) {
      if ((abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'] && e instanceof abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'])) {
        if (abap.Classes[lv_in_ce.get().trimEnd()] === undefined) { if (abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'.trimEnd()] === undefined) { throw "CX_SY_DYN_CALL_ILLEGAL_CLASS not found"; } else {throw new abap.Classes['CX_SY_DYN_CALL_ILLEGAL_CLASS'.trimEnd()](); } }
        lo_conv.set(await abap.Classes[lv_in_ce.get().trimEnd()].create({encoding: abap.CharacterFactory.get(5, 'UTF-8')}));
        await abap.dynamicCallLookup(lo_conv.get(), "convert")({data: iv_xstr,buffer: rv_str});
      } else {
        throw e;
      }
    }
  ...
  static async validate_array_index(INPUT) {
    ...
    if (!abap.compare.co(iv_index, abap.CharacterFactory.get(10, '0123456789'))) {
  ...
  static async normalize_path(INPUT) {
    ...
    if (abap.compare.eq(abap.builtin.strlen({val: rv_path}), abap.IntegerFactory.get(0))) {
      rv_path.set(abap.CharacterFactory.get(1, '/'));
    }
    if (abap.compare.ne(rv_path.getOffset({offset: 0, length: 1}), abap.CharacterFactory.get(1, '/'))) {
      rv_path.set(abap.operators.concat(abap.CharacterFactory.get(1, '/'),rv_path));
    }
    if (abap.compare.ne(abap.builtin.substring({val: rv_path, off: abap.operators.minus(abap.builtin.strlen({val: rv_path}),abap.IntegerFactory.get(1))}), abap.CharacterFactory.get(1, '/'))) {
      rv_path.set(abap.operators.concat(rv_path,abap.CharacterFactory.get(1, '/')));
    }
    return rv_path;
  }
  ...
  static async split_path(INPUT) {
    let rv_path_name = new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});
    let iv_path = INPUT?.iv_path;
    if (iv_path?.getQualifiedName === undefined || iv_path.getQualifiedName() !== "STRING") { iv_path = undefined; }
    if (iv_path === undefined) { iv_path = new abap.types.String({qualifiedName: "STRING"}).set(INPUT.iv_path); }
    ...
    if (abap.compare.eq(lv_len, abap.IntegerFactory.get(0)) || abap.compare.eq(iv_path, abap.CharacterFactory.get(1, '/'))) {
      return rv_path_name;
    }
    if (abap.compare.eq(abap.builtin.substring({val: iv_path, off: abap.operators.minus(lv_len,abap.IntegerFactory.get(1))}), abap.CharacterFactory.get(1, '/'))) {
      lv_trim_slash.set(abap.IntegerFactory.get(1));
    }
    lv_offs.set(abap.builtin.find({val: abap.builtin.reverse({val: iv_path}), sub: abap.CharacterFactory.get(1, '/'), off: lv_trim_slash}));
  ...
  async any_to_xstring(INPUT) {
    return lcl_utils.any_to_xstring(INPUT);
  }
  static async any_to_xstring(INPUT) {
    let rv_xstr = new abap.types.XString({qualifiedName: "XSTRING"});
    ...
    let lo_table_type = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TABLEDESCR", RTTIName: "\\CLASS=CL_ABAP_TABLEDESCR"});
    let lv_str = new abap.types.String({qualifiedName: "STRING"});
    let fs_data_ = new abap.types.FieldSymbol(abap.types.TableFactory.construct(new abap.types.Character(4), {"withHeader":false,"keyType":"DEFAULT"}));
    lo_type.set((await abap.Classes['CL_ABAP_TYPEDESCR'].describe_by_data({p_data: iv_data})));
    let unique1 = lo_type.get().type_kind;
    if (abap.compare.eq(unique1, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$binary.get().xstring)) {
      rv_xstr.set(iv_data);
    } else if (abap.compare.eq(unique1, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$texts.get().string) || abap.compare.eq(unique1, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$texts.get().char)) {
      rv_xstr.set((await this.string_to_xstring_utf8({iv_str: iv_data})));
    } else if (abap.compare.eq(unique1, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$table)) {
      await abap.statements.cast(lo_table_type, lo_type);
      if (abap.compare.ne(lo_table_type.get().table_kind, abap.Classes['CL_ABAP_TABLEDESCR'].tablekind_std)) {
        await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(56, 'Unsupported type of input table (must be standard table)')});
      }
      try {
        abap.statements.assign({target: fs_data_, source: iv_data});
        lv_str.set(abap.builtin.concat_lines_of({table: fs_data_, sep: abap.Classes['CL_ABAP_CHAR_UTILITIES'].newline}));
        rv_xstr.set((await this.string_to_xstring_utf8({iv_str: lv_str})));
      } catch (e) {
        if ((abap.Classes['CX_ROOT'] && e instanceof abap.Classes['CX_ROOT'])) {
          await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(53, 'Error converting input table (should be string_table)')});
        } else {
          throw e;
        }
      }
    } else {
      await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(74, 'Unsupported type of input (must be char, string, string_table, or xstring)')});
    }
    return rv_xstr;
  }
  async any_to_string(INPUT) {
    return lcl_utils.any_to_string(INPUT);
  }
  static async any_to_string(INPUT) {
    let rv_str = new abap.types.String({qualifiedName: "STRING"});
    let iv_data = INPUT?.iv_data;
    let lo_type = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TYPEDESCR", RTTIName: "\\CLASS=CL_ABAP_TYPEDESCR"});
    let lo_table_type = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TABLEDESCR", RTTIName: "\\CLASS=CL_ABAP_TABLEDESCR"});
    let fs_data_ = new abap.types.FieldSymbol(abap.types.TableFactory.construct(new abap.types.Character(4), {"withHeader":false,"keyType":"DEFAULT"}));
    lo_type.set((await abap.Classes['CL_ABAP_TYPEDESCR'].describe_by_data({p_data: iv_data})));
    let unique2 = lo_type.get().type_kind;
    if (abap.compare.eq(unique2, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$binary.get().xstring)) {
      rv_str.set((await this.xstring_to_string_utf8({iv_xstr: iv_data})));
    } else if (abap.compare.eq(unique2, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$texts.get().string) || abap.compare.eq(unique2, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$texts.get().char)) {
      rv_str.set(iv_data);
    } else if (abap.compare.eq(unique2, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$table)) {
      await abap.statements.cast(lo_table_type, lo_type);
      if (abap.compare.ne(lo_table_type.get().table_kind, abap.Classes['CL_ABAP_TABLEDESCR'].tablekind_std)) {
        await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(56, 'Unsupported type of input table (must be standard table)')});
      }
      try {
        abap.statements.assign({target: fs_data_, source: iv_data});
        rv_str.set(abap.builtin.concat_lines_of({table: fs_data_, sep: abap.Classes['CL_ABAP_CHAR_UTILITIES'].newline}));
      } catch (e) {
        if ((abap.Classes['CX_ROOT'] && e instanceof abap.Classes['CX_ROOT'])) {
          await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(53, 'Error converting input table (should be string_table)')});
        } else {
...
class lcl_json_parser {
  ...
  static IMPLEMENTED_INTERFACES = [];
  static ATTRIBUTES = {"MT_STACK": {"type": () => {return abap.types.TableFactory.construct(new abap.types.DataReference(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
  "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
  "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {})), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "lcl_json_parser=>ty_stack_tt");}, "visibility": "I", "is_constant": " ", "is_class": " "},
  ...
  "_PARSE": {"visibility": "I", "parameters": {"RT_JSON_TREE": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  "PARSE": {"visibility": "U", "parameters": {"RT_JSON_TREE": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  constructor() {
    ...
    this.FRIENDS_ACCESS_INSTANCE = {
      ...
      "_get_location": this.#_get_location.bind(this),
      "parse": this.parse.bind(this),
    };
    this.mt_stack = abap.types.TableFactory.construct(new abap.types.DataReference(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {})), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "lcl_json_parser=>ty_stack_tt");
  ...
  async parse(INPUT) {
    let rt_json_tree = abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");
    ...
    let lv_json = new abap.types.XString({qualifiedName: "XSTRING"});
    this.mv_keep_item_order.set(iv_keep_item_order);
    lv_json.set((await abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_UTILS'].any_to_xstring({iv_data: iv_json})));
    try {
      rt_json_tree.set((await this.#_parse({iv_json: lv_json})));
    } catch (e) {
      if ((abap.Classes['CX_SXML_PARSE_ERROR'] && e instanceof abap.Classes['CX_SXML_PARSE_ERROR'])) {
        lx_sxml_parse.set(e);
        lv_location.set((await this.#_get_location({iv_json: (await abap.Classes['CLAS-Z2UI5_CL_AJSON-LCL_UTILS'].any_to_string({iv_data: iv_json})), iv_offset: lx_sxml_parse.get().xml_offset})));
        ...
        lx_sxml.set(e);
        await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: new abap.types.String().set(`Json parsing error (SXML): ${abap.templateFormatting((await lx_sxml.get().if_message$get_text()))}`), iv_location: abap.CharacterFactory.get(7, '@PARSER')});
      } else {
        throw e;
      }
    }
  ...
  async #_parse(INPUT) {
    ...
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");
    let iv_json = INPUT?.iv_json;
    if (iv_json?.getQualifiedName === undefined || iv_json.getQualifiedName() !== "XSTRING") { iv_json = undefined; }
    if (iv_json === undefined) { iv_json = new abap.types.XString({qualifiedName: "XSTRING"}).set(INPUT.iv_json); }
    let lo_reader = new abap.types.ABAPObject({qualifiedName: "IF_SXML_READER", RTTIName: "\\INTERFACE=IF_SXML_READER"});
    let lr_stack_top = new abap.types.DataReference(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}));
    let lo_node = new abap.types.ABAPObject({qualifiedName: "IF_SXML_NODE", RTTIName: "\\INTERFACE=IF_SXML_NODE"});
    let fs_item_ = new abap.types.FieldSymbol(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    this.mt_stack.clear();
    this.mv_stack_path.clear();
    if (abap.compare.initial(iv_json)) {
      return rt_json_tree;
    }
    lo_reader.set((await abap.Classes['CL_SXML_STRING_READER'].create({input: iv_json})));
    ...
    while (true) {
      ...
      let unique4 = lo_node.get().if_sxml_node$type;
      if (abap.compare.eq(unique4, abap.Classes['IF_SXML_NODE'].if_sxml_node$co_nt_element_open)) {
        ...
        if (abap.compare.eq(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
          ...
          if (abap.compare.eq(lr_stack_top.get().type, new abap.types.String().set(`array`))) {
            ...
            for await (const unique5 of abap.statements.loop(lt_attributes)) {
              lo_attr.set(unique5);
              if (abap.compare.eq(lo_attr.get().if_sxml_attribute$qname.get().name, abap.CharacterFactory.get(4, 'name')) && abap.compare.eq(lo_attr.get().if_sxml_attribute$value_type, abap.Classes['IF_SXML_VALUE'].if_sxml_value$co_vt_text)) {
          ...
          if (abap.compare.initial(fs_item_.get().name)) {
            await this.#raise({iv_error: abap.CharacterFactory.get(34, 'Node without name (maybe not JSON)')});
          }
        }
        ...
        this.mv_stack_path.set(abap.operators.concat(this.mv_stack_path,abap.operators.concat(fs_item_.get().name,abap.CharacterFactory.get(1, '/'))));
      } else if (abap.compare.eq(unique4, abap.Classes['IF_SXML_NODE'].if_sxml_node$co_nt_element_close)) {
        ...
        if (abap.compare.ne(lo_close.get().if_sxml_close_element$qname.get().name, lr_stack_top.get().type)) {
          await this.#raise({iv_error: abap.CharacterFactory.get(28, 'Unexpected closing node type')});
        }
        this.mv_stack_path.set(abap.builtin.substring({val: this.mv_stack_path, len: abap.operators.add(abap.builtin.find({val: this.mv_stack_path, sub: abap.CharacterFactory.get(1, '/'), occ: abap.IntegerFactory.get(-2)}),abap.IntegerFactory.get(1))}));
      } else if (abap.compare.eq(unique4, abap.Classes['IF_SXML_NODE'].if_sxml_node$co_nt_value)) {
        await abap.statements.cast(lo_value, lo_node);
        fs_item_.get().value.set((await lo_value.get().if_sxml_value_node$get_value()));
      } else {
        await this.#raise({iv_error: abap.CharacterFactory.get(20, 'Unexpected node type')});
      }
    }
    abap.builtin.sy.get().index.set(indexBackup1);
    if (abap.compare.gt(abap.builtin.lines({val: this.mt_stack}), abap.IntegerFactory.get(0))) {
      await this.#raise({iv_error: abap.CharacterFactory.get(22, 'Unexpected end of data')});
    }
    return rt_json_tree;
  }
  async #raise(INPUT) {
...
lcl_json_parser.ty_stack_tt = abap.types.TableFactory.construct(new abap.types.DataReference(new abap.types.Structure({
"path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
"name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
"type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
"value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
...
class lcl_json_serializer {
  ...
  "MT_JSON_TREE": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  "STRINGIFY_NODE": {"visibility": "I", "parameters": {"IS_NODE": {"type": () => {return new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
  "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
  "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {});}, "is_optional": " "}}},
  ...
  "STRINGIFY": {"visibility": "U", "parameters": {"RV_JSON_STRING": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "IT_JSON_TREE": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  constructor() {
    ...
    this.INTERNAL_ID = abap.internalIdCounter++;
    this.FRIENDS_ACCESS_INSTANCE = {
      "_stringify": this.#_stringify.bind(this),
      "stringify_node": this.#stringify_node.bind(this),
      "stringify_set": this.#stringify_set.bind(this),
    };
    this.gv_comma_with_lf = lcl_json_serializer.gv_comma_with_lf;
    this.mt_json_tree = abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  static async class_constructor() {
    lcl_json_serializer.gv_comma_with_lf.set(abap.operators.concat(abap.CharacterFactory.get(1, ','),abap.Classes['CL_ABAP_CHAR_UTILITIES'].newline));
  }
  ...
  static async stringify(INPUT) {
    ...
    if (it_json_tree === undefined) { it_json_tree = abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    rv_json_string.set((await lo.get().FRIENDS_ACCESS_INSTANCE["_stringify"]()));
    return rv_json_string;
  }
  async #_stringify() {
    let rv_json_string = new abap.types.String({qualifiedName: "STRING"});
    let fs_n_ = new abap.types.FieldSymbol(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    abap.statements.readTable(this.mt_json_tree,{assigning: fs_n_,
      withKey: (i) => {return abap.compare.eq(i.path, abap.CharacterFactory.get(1, '')) && abap.compare.eq(i.name, abap.CharacterFactory.get(1, ''));},
      withKeyValue: [{key: (i) => {return i.path}, value: abap.CharacterFactory.get(1, '')},{key: (i) => {return i.name}, value: abap.CharacterFactory.get(1, '')}],
      usesTableLine: false,
      withKeySimple: {"path": abap.CharacterFactory.get(1, ''),"name": abap.CharacterFactory.get(1, '')}});
  ...
  async #stringify_node(INPUT) {
    ...
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}).set(INPUT.is_node); }
    ...
    let unique6 = is_node.get().type;
    if (abap.compare.eq(unique6, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().array)) {
      lv_item.set(abap.operators.concat(lv_item,abap.CharacterFactory.get(1, '[')));
    } else if (abap.compare.eq(unique6, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().object)) {
      lv_item.set(abap.operators.concat(lv_item,abap.CharacterFactory.get(1, '{')));
    } else if (abap.compare.eq(unique6, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().string)) {
    ...
    } else if (abap.compare.eq(unique6, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().boolean) || abap.compare.eq(unique6, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().number)) {
      lv_item.set(abap.operators.concat(lv_item,is_node.get().value));
    } else if (abap.compare.eq(unique6, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().null)) {
      lv_item.set(abap.operators.concat(lv_item,abap.CharacterFactory.get(4, 'null')));
    } else {
    ...
    if (abap.compare.eq(is_node.get().type, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().array) || abap.compare.eq(is_node.get().type, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().object)) {
      lv_children_path.set(abap.operators.concat(is_node.get().path,abap.operators.concat(is_node.get().name,abap.CharacterFactory.get(1, '/'))));
      let unique7 = is_node.get().type;
      if (abap.compare.eq(unique7, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().array)) {
        ...
        lv_tail.set(abap.CharacterFactory.get(1, ']'));
      } else if (abap.compare.eq(unique7, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().object)) {
        if (abap.compare.gt(is_node.get().children, abap.IntegerFactory.get(0))) {
  ...
  async #stringify_set(INPUT) {
    ...
    if (abap.compare.eq(iv_array, abap.builtin.abap_true)) {
      lv_tab_key.set(abap.CharacterFactory.get(11, 'array_index'));
    } else if (abap.compare.eq(this.mv_keep_item_order, abap.builtin.abap_true)) {
      lv_tab_key.set(abap.CharacterFactory.get(10, 'item_order'));
    } else {
      lv_tab_key.set(abap.CharacterFactory.get(11, 'primary_key'));
    }
    for await (const unique8 of abap.statements.loop(this.mt_json_tree,{usingKey: lv_tab_key.get(),where: async (I) => {return abap.compare.eq(I.path, iv_parent_path);},topEquals: {"path": iv_parent_path}})) {
      fs_n_.assign(unique8);
      if (abap.compare.eq(lv_first_done, abap.builtin.abap_false)) {
        ...
        abap.statements.append({source: abap.CharacterFactory.get(1, ','), target: this.mt_buffer});
      }
      await this.#stringify_node({is_node: fs_n_});
    }
  ...
  static async escape_string(INPUT) {
    ...
    if (abap.compare.ca(rv_escaped, new abap.types.String().set(`"\\\t\n\r`))) {
      rv_escaped.set(abap.builtin.replace({val: rv_escaped, sub: abap.CharacterFactory.get(1, '\\'), with: abap.CharacterFactory.get(2, '\\\\'), occ: abap.IntegerFactory.get(0)}));
      ...
      rv_escaped.set(abap.builtin.replace({val: rv_escaped, sub: new abap.types.String().set(`\r`), with: abap.CharacterFactory.get(2, '\\r'), occ: abap.IntegerFactory.get(0)}));
      rv_escaped.set(abap.builtin.replace({val: rv_escaped, sub: new abap.types.String().set(`\t`), with: abap.CharacterFactory.get(2, '\\t'), occ: abap.IntegerFactory.get(0)}));
      rv_escaped.set(abap.builtin.replace({val: rv_escaped, sub: abap.CharacterFactory.get(1, '"'), with: abap.CharacterFactory.get(2, '\\"'), occ: abap.IntegerFactory.get(0)}));
    }
    return rv_escaped;
  }
...
class lcl_json_to_abap {
  ...
  static IMPLEMENTED_INTERFACES = [];
  static ATTRIBUTES = {"MT_NODE_TYPE_CACHE": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
  "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
  "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
  "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"HASHED","isUnique":true,"keyFields":["TYPE_PATH"]},"secondary":[]}, "");}, "visibility": "I", "is_constant": " ", "is_class": " "},
  "MR_NODES": {"type": () => {return new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  static METHODS = {"ANY_TO_ABAP": {"visibility": "I", "parameters": {"IV_PATH": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "IS_PARENT_TYPE": {"type": () => {return new abap.types.Structure({
  "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
  "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
  "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
  "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {});}, "is_optional": " "}, "I_CONTAINER_REF": {"type": () => {return new abap.types.DataReference(new abap.types.Character(4));}, "is_optional": " "}}},
  "VALUE_TO_ABAP": {"visibility": "I", "parameters": {"IS_NODE": {"type": () => {return new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
  "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
  "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {});}, "is_optional": " "}, "IS_NODE_TYPE": {"type": () => {return new abap.types.Structure({
  "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
  "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
  "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
  "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {});}, "is_optional": " "}, "I_CONTAINER_REF": {"type": () => {return new abap.types.DataReference(new abap.types.Character(4));}, "is_optional": " "}}},
  "GET_NODE_TYPE": {"visibility": "I", "parameters": {"RS_NODE_TYPE": {"type": () => {return new abap.types.Structure({
  "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
  "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
  "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
  "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {});}, "is_optional": " "}, "IS_NODE": {"type": () => {return new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
  "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
  "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {});}, "is_optional": " "}, "IS_PARENT_TYPE": {"type": () => {return new abap.types.Structure({
  "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
  "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
  "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
  "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  ...
  "TO_ABAP": {"visibility": "U", "parameters": {"IT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
  "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
  "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
  "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
  "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  constructor() {
    ...
    this.INTERNAL_ID = abap.internalIdCounter++;
    this.FRIENDS_ACCESS_INSTANCE = {
      "any_to_abap": this.#any_to_abap.bind(this),
      "value_to_abap": this.#value_to_abap.bind(this),
      "get_node_type": this.#get_node_type.bind(this),
      "to_abap": this.to_abap.bind(this),
      "to_timestamp": this.to_timestamp.bind(this),
      "to_date": this.to_date.bind(this),
      "to_time": this.to_time.bind(this),
    };
    this.mt_node_type_cache = abap.types.TableFactory.construct(new abap.types.Structure({
    "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
    "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
    "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
    "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
    "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"HASHED","isUnique":true,"keyFields":["TYPE_PATH"]},"secondary":[]}, "");
    this.mr_nodes = new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  async to_abap(INPUT) {
    ...
    if (it_nodes === undefined) { it_nodes = abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    c_container.clear();
    this.mt_node_type_cache.clear();
    lr_ref.assign(c_container);
    this.mr_nodes.assign(it_nodes);
    await this.#get_node_type({i_container_ref: lr_ref});
    await this.#any_to_abap({iv_path: abap.CharacterFactory.get(1, ''), i_container_ref: lr_ref});
  }
  async #get_node_type(INPUT) {
    let rs_node_type = new abap.types.Structure({
    "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
    "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
    "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
    "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
    "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {});
    let is_node = new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    let is_parent_type = new abap.types.Structure({
    "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
    "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
    "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
    "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
    ...
    if (abap.compare.eq(is_parent_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$table)) {
      lv_node_type_path.set(abap.operators.concat(is_parent_type.get().type_path,abap.CharacterFactory.get(2, '/-')));
    } else if (abap.compare.initial(is_parent_type.get().type_kind) === false) {
      lv_node_type_path.set(abap.operators.concat(is_parent_type.get().type_path,abap.operators.concat(abap.CharacterFactory.get(1, '/'),is_node.get().name)));
    }
    ...
    if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
      ...
      let unique9 = is_parent_type.get().type_kind;
      if (abap.compare.eq(unique9, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$table)) {
      ...
      } else if (abap.compare.eq(unique9, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$struct_flat) || abap.compare.eq(unique9, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$struct_deep)) {
        ...
        } else if (abap.compare.eq(unique9, abap.CharacterFactory.get(1, ''))) {
    ...
    async #any_to_abap(INPUT) {
      ...
      let ls_node_type = new abap.types.Structure({
      "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
      "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
      "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
      "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
      ...
      try {
        for await (const unique11 of abap.statements.loop(this.mr_nodes.dereference(),{usingKey: "array_index",where: async (I) => {return abap.compare.eq(I.path, iv_path);},topEquals: {"path": iv_path}})) {
          fs_n_.assign(unique11);
          ...
          if (abap.compare.eq(ls_node_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$data_ref) || abap.compare.eq(ls_node_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$object_ref)) {
            await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(20, 'Cannot assign to ref')});
          }
          let unique12 = is_parent_type.get().type_kind;
          if (abap.compare.eq(unique12, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$table)) {
            if (!abap.compare.co(ls_node_type.get().target_field_name, abap.CharacterFactory.get(10, '0123456789'))) {
              await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(27, 'Need index to access tables')});
            }
          ...
          } else if (abap.compare.eq(unique12, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$struct_flat) || abap.compare.eq(unique12, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$struct_deep)) {
          ...
          } else if (abap.compare.eq(unique12, abap.CharacterFactory.get(1, ''))) {
            lr_target_field.set(i_container_ref);
          } else {
            await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(22, 'Unexpected parent type')});
          }
          let unique13 = fs_n_.get().type;
          if (abap.compare.eq(unique13, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().object)) {
            if (abap.compare.ne(ls_node_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$struct_flat) && abap.compare.ne(ls_node_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$struct_deep)) {
              await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(18, 'Expected structure')});
            }
            await this.#any_to_abap({iv_path: abap.operators.concat(fs_n_.get().path,abap.operators.concat(fs_n_.get().name,abap.CharacterFactory.get(1, '/'))), is_parent_type: ls_node_type, i_container_ref: lr_target_field});
          } else if (abap.compare.eq(unique13, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().array)) {
            if (!abap.compare.eq(ls_node_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$table)) {
              await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(14, 'Expected table')});
            }
            await this.#any_to_abap({iv_path: abap.operators.concat(fs_n_.get().path,abap.operators.concat(fs_n_.get().name,abap.CharacterFactory.get(1, '/'))), is_parent_type: ls_node_type, i_container_ref: lr_target_field});
          } else {
          ...
          if (abap.compare.initial(is_parent_type.get().tab_item_buf) === false) {
            try {
              ...
              if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
                await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(19, 'Duplicate insertion')});
              }
            } catch (e) {
        ...
        if ((abap.Classes['Z2UI5_CX_AJSON_ERROR'] && e instanceof abap.Classes['Z2UI5_CX_AJSON_ERROR'])) {
          ...
          await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(22, 'Source is not a number'), iv_location: abap.operators.concat(fs_n_.get().path,fs_n_.get().name)});
    ...
    async #value_to_abap(INPUT) {
      ...
      if (is_node_type === undefined) { is_node_type = new abap.types.Structure({
      "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
      "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
      "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
      "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
      "tab_item_buf": new abap.types.DataReference(new abap.types.Character(4))}, "lcl_json_to_abap=>ty_type_cache", undefined, {}, {}).set(INPUT.is_node_type); }
      let i_container_ref = INPUT?.i_container_ref;
      if (i_container_ref === undefined) { i_container_ref = new abap.types.DataReference(new abap.types.Character(4)).set(INPUT.i_container_ref); }
      ...
      abap.statements.assert(abap.compare.eq(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0)));
      let unique14 = is_node.get().type;
      if (abap.compare.eq(unique14, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().null)) {
      } else if (abap.compare.eq(unique14, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().boolean)) {
        fs_container_.set(abap.builtin.boolc(abap.compare.eq(is_node.get().value, abap.CharacterFactory.get(4, 'true'))));
      } else if (abap.compare.eq(unique14, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().number)) {
        fs_container_.set(is_node.get().value);
      } else if (abap.compare.eq(unique14, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().string)) {
        if (abap.compare.initial(is_node.get().value) === false) {
          ...
          } else if (abap.compare.eq(is_node_type.get().dd.get().absolute_name, abap.CharacterFactory.get(15, '\\TYPE=TIMESTAMP')) || abap.compare.eq(is_node_type.get().dd.get().absolute_name, abap.CharacterFactory.get(16, '\\TYPE=TIMESTAMPL'))) {
    ...
    async to_date(INPUT) {
      ...
      abap.statements.find(iv_value, {regex: abap.CharacterFactory.get(29, '^(\\d{4})-(\\d{2})-(\\d{2})(T|$)'), first: true, submatches: [lv_y,lv_m,lv_d]});
      if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
        await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(22, 'Unexpected date format')});
      }
    ...
    async to_timestamp(INPUT) {
      ...
      let ls_timestamp = new abap.types.Structure({
      "year": new abap.types.Character(4, {}),
      "month": new abap.types.Character(2, {}),
      "day": new abap.types.Character(2, {}),
      "t": new abap.types.Character(1, {}),
      "hour": new abap.types.Character(2, {}),
      "minute": new abap.types.Character(2, {}),
      "second": new abap.types.Character(2, {}),
      "local_sign": new abap.types.Character(1, {}),
      "local_hour": new abap.types.Character(2, {}),
      "local_minute": new abap.types.Character(2, {})}, undefined, undefined, {}, {});
      ...
      if (abap.compare.eq(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
        ...
        if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
          await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(27, 'Unexpected timestamp format')});
        }
      }
      ...
      try {
        let unique15 = ls_timestamp.get().local_sign;
        if (abap.compare.eq(unique15, abap.CharacterFactory.get(1, '-'))) {
          lv_timestamp.set((await abap.Classes['CL_ABAP_TSTMP'].add({tstmp: lv_timestamp, secs: lv_seconds_conv})));
        } else if (abap.compare.eq(unique15, abap.CharacterFactory.get(1, '+'))) {
        ...
        if ((abap.Classes['CX_PARAMETER_INVALID_RANGE'] && e instanceof abap.Classes['CX_PARAMETER_INVALID_RANGE']) || (abap.Classes['CX_PARAMETER_INVALID_TYPE'] && e instanceof abap.Classes['CX_PARAMETER_INVALID_TYPE'])) {
          await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(38, 'Unexpected error calculating timestamp')});
        } else {
          throw e;
        }
      }
    ...
    async to_time(INPUT) {
      ...
      abap.statements.find(iv_value, {regex: abap.CharacterFactory.get(29, '^(\\d{2}):(\\d{2}):(\\d{2})(T|$)'), first: true, submatches: [lv_h,lv_m,lv_s]});
      if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
        await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(22, 'Unexpected time format')});
      }
  ...
  lcl_json_to_abap.ty_type_cache = new abap.types.Structure({
  "type_path": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TYPE_PATH"}),
  "target_field_name": new abap.types.String({qualifiedName: "LCL_JSON_TO_ABAP=>TY_TYPE_CACHE-TARGET_FIELD_NAME"}),
  "dd": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"}),
  "type_kind": new abap.types.Character(1, {"qualifiedName":"lif_kind=>ty_kind"}),
  ...
  class lcl_abap_to_json {
    ...
    static METHODS = {"CONVERT_ANY": {"visibility": "I", "parameters": {"IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IO_TYPE": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TYPEDESCR", RTTIName: "\\CLASS=CL_ABAP_TYPEDESCR"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "CONVERT_AJSON": {"visibility": "I", "parameters": {"IO_JSON": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_AJSON", RTTIName: "\\INTERFACE=Z2UI5_IF_AJSON"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "CONVERT_VALUE": {"visibility": "I", "parameters": {"IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IO_TYPE": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TYPEDESCR", RTTIName: "\\CLASS=CL_ABAP_TYPEDESCR"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "CONVERT_REF": {"visibility": "I", "parameters": {"IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "CONVERT_STRUC": {"visibility": "I", "parameters": {"IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IO_TYPE": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TYPEDESCR", RTTIName: "\\CLASS=CL_ABAP_TYPEDESCR"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "CONVERT_TABLE": {"visibility": "I", "parameters": {"IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IO_TYPE": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TYPEDESCR", RTTIName: "\\CLASS=CL_ABAP_TYPEDESCR"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "INSERT_VALUE_WITH_TYPE": {"visibility": "I", "parameters": {"IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IV_TYPE": {"type": () => {return new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"});}, "is_optional": " "}, "IO_TYPE": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "CL_ABAP_TYPEDESCR", RTTIName: "\\CLASS=CL_ABAP_TYPEDESCR"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "CT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}}},
    "CONVERT": {"visibility": "U", "parameters": {"RT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}, "IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_ARRAY_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "II_CUSTOM_MAPPING": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_AJSON_MAPPING", RTTIName: "\\INTERFACE=Z2UI5_IF_AJSON_MAPPING"});}, "is_optional": " "}, "IS_OPTS": {"type": () => {return new abap.types.Structure({
    "read_only": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
    "keep_item_order": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
    "format_datetime": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
    "to_abap_corresponding_only": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_if_ajson=>ty_opts", undefined, {}, {});}, "is_optional": " "}, "IV_ITEM_ORDER": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}}},
    "INSERT_WITH_TYPE": {"visibility": "U", "parameters": {"RT_NODES": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    "index": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-INDEX"}),
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");}, "is_optional": " "}, "IV_DATA": {"type": () => {return new abap.types.Character(4);}, "is_optional": " "}, "IV_TYPE": {"type": () => {return new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"});}, "is_optional": " "}, "IS_PREFIX": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});}, "is_optional": " "}, "IV_ARRAY_INDEX": {"type": () => {return new abap.types.Integer({qualifiedName: "I"});}, "is_optional": " "}, "II_CUSTOM_MAPPING": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_AJSON_MAPPING", RTTIName: "\\INTERFACE=Z2UI5_IF_AJSON_MAPPING"});}, "is_optional": " "}, "IS_OPTS": {"type": () => {return new abap.types.Structure({
    "read_only": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
    "keep_item_order": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
    ...
    constructor() {
      ...
      this.INTERNAL_ID = abap.internalIdCounter++;
      this.FRIENDS_ACCESS_INSTANCE = {
        "convert_any": this.#convert_any.bind(this),
        "convert_ajson": this.#convert_ajson.bind(this),
        "convert_value": this.#convert_value.bind(this),
        "convert_ref": this.#convert_ref.bind(this),
        "convert_struc": this.#convert_struc.bind(this),
        "convert_table": this.#convert_table.bind(this),
        "insert_value_with_type": this.#insert_value_with_type.bind(this),
      };
    ...
    static async convert(INPUT) {
      ...
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");
      let iv_data = INPUT?.iv_data;
      let is_prefix = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});
      ...
      let ii_custom_mapping = new abap.types.ABAPObject({qualifiedName: "Z2UI5_IF_AJSON_MAPPING", RTTIName: "\\INTERFACE=Z2UI5_IF_AJSON_MAPPING"});
      if (INPUT && INPUT.ii_custom_mapping) {ii_custom_mapping.set(INPUT.ii_custom_mapping);}
      let is_opts = new abap.types.Structure({
      "read_only": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
      "keep_item_order": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
      "format_datetime": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}),
      "to_abap_corresponding_only": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"})}, "z2ui5_if_ajson=>ty_opts", undefined, {}, {});
      ...
      await lo_converter.get().FRIENDS_ACCESS_INSTANCE["convert_any"]({iv_data: iv_data, io_type: lo_type, is_prefix: is_prefix, iv_index: iv_array_index, iv_item_order: iv_item_order, ct_nodes: rt_nodes});
      return rt_nodes;
    }
    async #convert_any(INPUT) {
      ...
      if (is_prefix === undefined) { is_prefix = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {}).set(INPUT.is_prefix); }
      ...
      if (INPUT && INPUT.iv_item_order) {iv_item_order.set(INPUT.iv_item_order);}
      if (INPUT === undefined || INPUT.iv_item_order === undefined) {iv_item_order = abap.IntegerFactory.get(0);}
      let ct_nodes = abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      let unique16 = io_type.get().kind;
      if (abap.compare.eq(unique16, abap.Classes['CL_ABAP_TYPEDESCR'].kind_elem)) {
      ...
      } else if (abap.compare.eq(unique16, abap.Classes['CL_ABAP_TYPEDESCR'].kind_struct)) {
      ...
      } else if (abap.compare.eq(unique16, abap.Classes['CL_ABAP_TYPEDESCR'].kind_table)) {
    ...
    async #convert_ajson(INPUT) {
      ...
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");
      if (INPUT && INPUT.ct_nodes) {ct_nodes = INPUT.ct_nodes;}
      let fs_src_ = new abap.types.FieldSymbol(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}));
      let fs_dst_ = new abap.types.FieldSymbol(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      for await (const unique17 of abap.statements.loop(io_json.get().z2ui5_if_ajson$mt_json_tree)) {
        fs_src_.assign(unique17);
    ...
    static async format_date(INPUT) {
      ...
      if (abap.compare.initial(iv_date) === false) {
        rv_str.set(abap.operators.concat(iv_date.getOffset({offset: 0, length: 4}),abap.operators.concat(abap.CharacterFactory.get(1, '-'),abap.operators.concat(iv_date.getOffset({offset: 4, length: 2}),abap.operators.concat(abap.CharacterFactory.get(1, '-'),iv_date.getOffset({offset: 6, length: 2}))))));
      }
      return rv_str;
    }
    ...
    static async format_time(INPUT) {
      ...
      if (abap.compare.initial(iv_time) === false) {
        rv_str.set(abap.operators.concat(iv_time.getOffset({offset: 0, length: 2}),abap.operators.concat(abap.CharacterFactory.get(1, ':'),abap.operators.concat(iv_time.getOffset({offset: 2, length: 2}),abap.operators.concat(abap.CharacterFactory.get(1, ':'),iv_time.getOffset({offset: 4, length: 2}))))));
      }
      return rv_str;
    }
    ...
    async #convert_value(INPUT) {
      ...
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["PATH","NAME"]},"secondary":[]}, "z2ui5_if_ajson_types=>ty_nodes_tt");
      if (INPUT && INPUT.ct_nodes) {ct_nodes = INPUT.ct_nodes;}
      let ls_node = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      if (abap.compare.eq(io_type.get().absolute_name, abap.CharacterFactory.get(30, '\\TYPE-POOL=ABAP\\TYPE=ABAP_BOOL')) || abap.compare.eq(io_type.get().absolute_name, abap.CharacterFactory.get(18, '\\TYPE=ABAP_BOOLEAN')) || abap.compare.eq(io_type.get().absolute_name, abap.CharacterFactory.get(16, '\\TYPE=XSDBOOLEAN')) || abap.compare.eq(io_type.get().absolute_name, abap.CharacterFactory.get(10, '\\TYPE=FLAG')) || abap.compare.eq(io_type.get().absolute_name, abap.CharacterFactory.get(11, '\\TYPE=XFELD'))) {
        ...
        if (abap.compare.initial(iv_data) === false) {
          ls_node.get().value.set(abap.CharacterFactory.get(4, 'true'));
        } else {
          ls_node.get().value.set(abap.CharacterFactory.get(5, 'false'));
        }
      } else if (abap.compare.eq(io_type.get().absolute_name, abap.CharacterFactory.get(15, '\\TYPE=TIMESTAMP'))) {
    ...
    async #convert_ref(INPUT) {
      ...
      if (abap.compare.initial(iv_data)) {
        ...
        ls_node.get().value.set(abap.CharacterFactory.get(4, 'null'));
      } else {
    ...
    async #convert_struc(INPUT) {
      ...
      "type": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR", RTTIName: "\\CLASS=CL_ABAP_DATADESCR"})}, "abap_simple_componentdescr", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":["NAME"]},"secondary":[]}, "abap_component_view_tab");
      let ls_next_prefix = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_PATH_NAME-NAME"})}, "z2ui5_if_ajson_types=>ty_path_name", undefined, {}, {});
      ...
      let ls_root = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {});
      let fs_root_ = new abap.types.FieldSymbol(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}));
      let fs_c_ = new abap.types.FieldSymbol(new abap.types.Structure({
      "name": new abap.types.String({qualifiedName: "NAME"}),
      ...
      ls_next_prefix.get().path.set(abap.operators.concat(is_prefix.get().path,abap.operators.concat(fs_root_.get().name,abap.CharacterFactory.get(1, '/'))));
      for await (const unique18 of abap.statements.loop(lt_comps)) {
        fs_c_.assign(unique18);
        lv_mapping_prefix_name.clear();
    ...
    async #convert_table(INPUT) {
      ...
      for await (const unique19 of abap.statements.loop(fs_tab_)) {
        fs_val_.assign(unique19);
    ...
    static async insert_with_type(INPUT) {
      ...
      lo_converter.get().mv_keep_item_order.set(is_opts.get().keep_item_order);
      lo_converter.get().mv_format_datetime.set(is_opts.get().format_datetime);
      await lo_converter.get().FRIENDS_ACCESS_INSTANCE["insert_value_with_type"]({iv_data: iv_data, iv_type: iv_type, io_type: lo_type, is_prefix: is_prefix, iv_index: iv_array_index, iv_item_order: iv_item_order, ct_nodes: rt_nodes});
      return rt_nodes;
    }
    async #insert_value_with_type(INPUT) {
      ...
      if (abap.compare.co(io_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$texts) || abap.compare.co(io_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$date) || abap.compare.co(io_type.get().type_kind, abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_KIND'].lif_kind$time)) {
        if (abap.compare.eq(iv_type, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().boolean) && abap.compare.ne(iv_data, abap.CharacterFactory.get(4, 'true')) && abap.compare.ne(iv_data, abap.CharacterFactory.get(5, 'false'))) {
        ...
        } else if (abap.compare.eq(iv_type, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().number) && abap.compare.cn(iv_data, abap.CharacterFactory.get(15, '0123456789. E+-'))) {
  ...
  class lif_mutator_runner {
    static INTERNAL_TYPE = 'INTF';
    static ATTRIBUTES = {};
    static METHODS = {"RUN": {"visibility": "U", "parameters": {"IT_SOURCE_TREE": {"type": () => {return abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
  ...
  abap.Classes['CLAS-Z2UI5_CL_AJSON-LIF_MUTATOR_RUNNER'] = lif_mutator_runner;class lcl_filter_runner {
    ...
    "MR_SOURCE_TREE": {"type": () => {return new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["PATH","NAME"]},"secondary":[{"name":"array_index","type":"SORTED","isUnique":false,"keyFields":["PATH","INDEX"]},{"name":"item_order","type":"SORTED","isUnique":false,"keyFields":["PATH","ORDER"]}]}, "z2ui5_if_ajson_types=>ty_nodes_ts"));}, "visibility": "I", "is_constant": " ", "is_class": " "},
    "MR_DEST_TREE": {"type": () => {return new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
    "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["PATH","NAME"]},"secondary":[{"name":"array_index","type":"SORTED","isUnique":false,"keyFields":["PATH","INDEX"]},{"name":"item_order","type":"SORTED","isUnique":false,"keyFields":["PATH","ORDER"]}]}, "z2ui5_if_ajson_types=>ty_nodes_ts"));}, "visibility": "I", "is_constant": " ", "is_class": " "}};
    static METHODS = {"WALK": {"visibility": "I", "parameters": {"IV_PATH": {"type": () => {return new abap.types.String({qualifiedName: "STRING"});}, "is_optional": " "}, "CS_PARENT": {"type": () => {return new abap.types.Structure({
    "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
    "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
    "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
    "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    constructor() {
      ...
      this.mr_source_tree = new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["PATH","NAME"]},"secondary":[{"name":"array_index","type":"SORTED","isUnique":false,"keyFields":["PATH","INDEX"]},{"name":"item_order","type":"SORTED","isUnique":false,"keyFields":["PATH","ORDER"]}]}, "z2ui5_if_ajson_types=>ty_nodes_ts"));
      this.mr_dest_tree = new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
    ...
    async lif_mutator_runner$run(INPUT) {
      ...
      if (it_source_tree === undefined) { it_source_tree = abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      let et_dest_tree = INPUT?.et_dest_tree || abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      await this.#walk({iv_path: abap.CharacterFactory.get(1, '')});
    }
    async #walk(INPUT) {
      let iv_path = INPUT?.iv_path;
      if (iv_path?.getQualifiedName === undefined || iv_path.getQualifiedName() !== "STRING") { iv_path = undefined; }
      if (iv_path === undefined) { iv_path = new abap.types.String({qualifiedName: "STRING"}).set(INPUT.iv_path); }
      let cs_parent = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      for await (const unique20 of abap.statements.loop(this.mr_source_tree.dereference(),{usingKey: lv_tab_key.get(),where: async (I) => {return abap.compare.eq(I.path, iv_path);},topEquals: {"path": iv_path}})) {
        ls_node.set(unique20);
        let unique21 = ls_node.get().type;
        if (abap.compare.eq(unique21, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().boolean) || abap.compare.eq(unique21, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().null) || abap.compare.eq(unique21, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().number) || abap.compare.eq(unique21, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().string)) {
          if (abap.compare.eq((await this.mi_filter.get().z2ui5_if_ajson_filter$keep_node({is_node: ls_node})), abap.builtin.abap_false)) {
            continue;
          }
        } else if (abap.compare.eq(unique21, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().array) || abap.compare.eq(unique21, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().object)) {
  ...
  class lcl_mapper_runner {
    ...
    constructor() {
      ...
      this.INTERNAL_ID = abap.internalIdCounter++;
      this.FRIENDS_ACCESS_INSTANCE = {
        "process_deep_node": this.#process_deep_node.bind(this),
      };
    ...
    async #process_deep_node(INPUT) {
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}));
      let ls_renamed_node = new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {});
      for await (const unique22 of abap.statements.loop(this.mr_source_tree.dereference(),{where: async (I) => {return abap.compare.eq(I.path, iv_path);},topEquals: {"path": iv_path}})) {
        fs_item_.assign(unique22);
        ...
        if (abap.compare.ne(iv_node_type, abap.Classes['Z2UI5_IF_AJSON_TYPES'].z2ui5_if_ajson_types$node_type.get().array)) {
          ...
          if (abap.compare.initial(ls_renamed_node.get().name)) {
            await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(33, 'Renamed node name cannot be empty'), is_node: fs_item_});
          }
        }
        ...
        if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
          await abap.Classes['Z2UI5_CX_AJSON_ERROR'].raise({iv_msg: abap.CharacterFactory.get(28, 'Renamed node has a duplicate'), is_node: ls_renamed_node});
        }
  ...
  class lcl_mutator_queue {
    ...
    async lif_mutator_runner$run(INPUT) {
      ...
      let fs_from_ = new abap.types.FieldSymbol(abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["PATH","NAME"]},"secondary":[{"name":"array_index","type":"SORTED","isUnique":false,"keyFields":["PATH","INDEX"]},{"name":"item_order","type":"SORTED","isUnique":false,"keyFields":["PATH","ORDER"]}]}, "z2ui5_if_ajson_types=>ty_nodes_ts"));
      let fs_to_ = new abap.types.FieldSymbol(abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      "order": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-ORDER"}),
      "children": new abap.types.Integer({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-CHILDREN"})}, "z2ui5_if_ajson_types=>ty_node", undefined, {}, {}), {"withHeader":false,"keyType":"USER","primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["PATH","NAME"]},"secondary":[{"name":"array_index","type":"SORTED","isUnique":false,"keyFields":["PATH","INDEX"]},{"name":"item_order","type":"SORTED","isUnique":false,"keyFields":["PATH","ORDER"]}]}, "z2ui5_if_ajson_types=>ty_nodes_ts"));
      let lr_buf = new abap.types.DataReference(abap.types.TableFactory.construct(new abap.types.Structure({
      "path": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-PATH"}),
      "name": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-NAME"}),
      "type": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE_TYPE"}),
      "value": new abap.types.String({qualifiedName: "Z2UI5_IF_AJSON_TYPES=>TY_NODE-VALUE"}),
      ...
      for await (const unique23 of abap.statements.loop(this.mt_queue)) {
        li_mutator.set(unique23);
...
//# sourceMappingURL=output_z2ui5_cl_ajson_clas_locals_mjs.bundle.js.map